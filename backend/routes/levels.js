...
router.get('/latest', async (req, res) => {
  try {
    ...
    console.log('Has cauldron_levels?', !!latestRecord?.cauldron_levels);
    ...
    if (latestRecord && latestRecord.cauldron_levels) {
      ...
      console.log('Returning', result.length, 'cauldron records');
      res.json(result);
    } else {
      console.log('No cauldron_levels found, returning empty array');
      res.json([]);
    }
  } catch (error) {
